...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      { path: 'admin', name: 'admin', component: () => import('@/views/table/admin'), meta: { title: '管理员管理', icon: 'table' }},
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'articleAdd', name: 'articleAdd', component: () => import('@/views/table/articleAdd'), meta: { title: '发布文章', icon: 'table' }},
